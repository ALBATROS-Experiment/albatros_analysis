...
#--------------------hard coded setup------------
config_name = "config3_corr.json"
satdet_name = "pulsedata_1753200150_len_86260_1760835173.json"
...
bl1_ants = set({'Antenna 5', 'Antenna 6'})
bl2_ants = set({'Antenna 5', 'Antenna 7'})
required_ants = bl1_ants | bl2_ants

rel_start_t, rel_end_t = 16545, 16810
satID = 57166

bl1_offsets = [-1895548, -901873]
bl2_offsets = [-1895548, -2123503]
...
p_vis1, phase1, chan_big_idx1 = su.get_fringes_phase(bl1_pol00, chanlist)
p_vis2, phase2, chan_big_idx2 = su.get_fringes_phase(bl2_pol00, chanlist)

res1 = fgs.plot_phase_residuals(phase1,
                                [bl1_coords[0], bl1_coords[1]],
                                [p_start, p_end],
                                 chan_big_idx,
                                 57166,
                                 T_SPECTRA = T_SPECTRA,
...
res2 = fgs.plot_phase_residuals(phase2,
                                [bl2_coords[0], bl2_coords[1]],
                                [p_start, p_end],
                                chan_big_idx,
                                57166,
                                T_SPECTRA = T_SPECTRA,
...
res1.savefig(os.path.join(out_path, f'res_bline1.jpg'))
res2.savefig(os.path.join(out_path, f'res_bline2.jpg'))
