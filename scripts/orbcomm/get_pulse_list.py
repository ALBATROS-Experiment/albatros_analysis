...
if __name__ == '__main__':
    ...
    parser.add_argument("ref_ant", type=str, default="MARS2", help='The antenna that was used as reference for satdet')
...
# ])
    ...
    path_out = os.path.join(path_batch, f'data/pulses_june9.json')
