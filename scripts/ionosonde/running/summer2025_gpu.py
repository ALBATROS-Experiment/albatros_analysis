...
with open(summary_path, "a") as failure_summary:
    ...
    for ant in [3, 4, 5, 6, 7, 8, 1, 2]:
        baseband_dir = f"/scratch/mohanagr/summer_2025/baseband/mars{ant}"
        folder_names = [folder_name for folder_name in os.listdir(baseband_dir) if folder_name.isdigit()]
