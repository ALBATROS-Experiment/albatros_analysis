...
def plot_one(folder_path, time, ant, summary_file):
    ...
    ref_freq, est_plasma_freq, pol0, pol1 = process_and_plot(ref_idx_plotting = True, args = args)
    ...
    for time_sup_folder in time_sup_folder_names:
        ...
        for time_folder in time_folder_names:
            ...
            for ant_folder in ant_folder_names:
                ...
                pol0, pol1 = plot_one(total_path, time, ant_folder[-1], failure_summary)
                data_dict[f"{time}_mars{ant_folder[-1]}_pol0"] = pol0
                data_dict[f"{time}_mars{ant_folder[-1]}_pol1"] = pol1
                counter +=1
