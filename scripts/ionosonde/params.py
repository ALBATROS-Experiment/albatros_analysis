...
ipfb_chunk_size = 409600 # 1000000
...
dsamp = int(adc_samp_freq / code_baudrate)
...
ionosonde_freqs = np.loadtxt(f"{os.path.expanduser('~')}/albatros_analysis/scripts/ionosonde/eureka_freqs_hz.csv", skiprows = 1)
