...
def get_avg_fast_1bit(path, init_t, end_t, acclen, nchunks):
...
if __name__=="__main__":
    ...
    # assert(1==0)
    pol01_1,channels = get_avg_fast_1bit(args.data_dir, args.time_start, args.time_stop, args.acclen, args.nchunks)
    print("RUN 1 DONE")
