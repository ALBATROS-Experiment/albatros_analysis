...
The [Pipeline Pages](pipeline/index.md) give a detailed overview and explanation of each component of the code. This is best for newcomers who want to understand what is happening as a whole, or for people who want some reasoning as to why specific design choices were made.
...
This section is split into [Science Tests](testing/science/index.html) which aims to validate physical results, and [Software Tests](testing/software/index.html) which aim to validate computation techniques and data processing. Testing is mainly present for analysts using the pipeline who wish to verify their code and document the results.
