...
if __name__ == '__main__':
    ...
    print(f'Getting log information from {logdir}')
    ...
    for ctstamp in ctstamp_list:
        print('##########################################################')
        print(f'Log information for {ctstamp}')
        tstamp = datetime.datetime.utcfromtimestamp(ctstamp)
        print(f'Time stamp (UTC) {tstamp}')
        ...
        print(f'Nearest baseband log file (time diff = {dt} minutes):')
