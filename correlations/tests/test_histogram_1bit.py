...
def test_histogram_1bit_file(file_obj_packed):
    ...
    assert(np.sum(r1)==file_obj_packed.pol0.shape[0]*file_obj_packed.pol0.shape[1]*8) #conservation of bits
    assert(np.sum(r2)==file_obj_packed.pol1.shape[0]*file_obj_packed.pol1.shape[1]*8) #conservation of bits
    assert(np.sum(hist1)==file_obj_packed.pol0.shape[0]*file_obj_packed.pol0.shape[1]*8)
    assert(np.sum(hist2)==file_obj_packed.pol1.shape[0]*file_obj_packed.pol1.shape[1]*8)
